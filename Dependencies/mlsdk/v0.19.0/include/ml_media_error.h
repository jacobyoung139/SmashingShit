...
/*! Generic error codes for the multimedia framework. */
...
typedef enum MLMediaDRMResult {
  ...
  /*!
    \brief Error Code when an operation on a \ref MediaDRM handle is attempted
    and the device does not have a certificate.
    The app should obtain and install a certificate using the \ref MediaDRM
...
/*! \brief Translate a media error code into a human-readable string
    ...
    \retval C-style ascii string containing readable version of result code.
