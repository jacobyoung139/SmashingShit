...
/*!
  ...
  \retval \c MLPrivilegesResult_Granted if the privilege is granted.
  \retval \c MLPrivilegesResult_Denied if the privilege is denied.
  \retval \c MLResult_UnspecifiedFailure if the privilege system was not started.
  \priv none
*/
...
/*!
  ...
  \retval \c MLResult_Ok if the privilege request is in progress.
  \retval \c MLResult_InvalidParam if request is a null pointer.
  \retval \c MLResult_UnspecifiedFailure if the privilege system was not started.
  \priv none
*/
...
/*!
  ...
  \retval \c MLPrivilegesResult_Granted if the privilege is granted.
  \retval \c MLPrivilegesResult_Denied if the privilege is denied.
  \retval \c MLResult_Pending if the privilege request is in progress.
  \retval \c MLResult_InvalidParam if request is a null pointer.
  \retval \c MLResult_UnspecifiedFailure if the privilege system was not started.
  \priv none
*/
