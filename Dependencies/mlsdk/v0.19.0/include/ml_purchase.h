...
/*!
  ...
  \retval MLResult_AllocFailed is returned if the handle cannot be allocated.
  \retval MLResult_UnspecifiedFailure indicates an unexpected failure.
  \retval MLResult_Ok is returned on success.
  \priv none
 */
ML_API MLResult ML_CALL MLPurchaseItemDetailsCreate(MLHandle *out_handle);

/*!
  \brief Submits the details query for the provided in-app purchase ids.
  \param item_details_handle This is the query handle created by MLPurchaseItemDetailsCreate.
  \param request This is a query struct containing the list of items to request.
  ...
  \retval MLResult_InvalidParam is returned if any input parameters are invalid.
...
/*!
  ...
  \param item_details_handle This is the handle that was used to call MLPurchaseItemDetails.
  ...
  \retval MLCloudResult_NetworkError is returned if there is a network connectivity error for the service call.
  \retval MLResult_InvalidParam is returned if any input parameters are invalid.
  \retval MLResult_PrivilegeDenied indicates an privilege error with the purchase details system call.
  \retval MLResult_UnspecifiedFailure indicates an unexpected failure.
  \retval MLResult_Ok is returned on success.
...
/*!
  ...
  \param item_details_handle This is a handle that was created by MLPurchaseItemDetailsCreate.
  \retval MLCloudResult_InvalidHandle indicates the provided query handle is not valid.
  \retval MLResult_UnspecifiedFailure indicates an unexpected failure.
  \retval MLResult_Ok is returned on success.
  \priv none
...
/*!
  ...
  \param purchase_handle This is a handle created by MLPurchaseCreate, used to identify this purchase attempt.
  \param token This identifies the in-app purchase item to be purchased by this call. This should have been copied
...
/*!
  ...
  \param purchase_handle This handle represents the in-app purchase submitted vai MLPurchaseSubmit.
  ...
  \retval MLPurchaseResult_InvalidPurchaseToken is returned if the token representing the in-app purchase is not valid.
  \retval MLPurchaseResult_ItemUnavailable indicates the item is no longer available.
  \retval MLPurchaseResult_NoDefaultPayment is returned if the user has not configured a default payment method.
  \retval MLCloudResult_InvalidHandle indicates the provided query handle is not valid.
  \retval MLCloudResult_SystemError indicates an issue with the cloud service, e.g. if the service is not available for any reason.
  \retval MLCloudResult_NotFound indicates the requested resource was not found on the server.
  \retval MLCloudResult_ServerError if there is an unexepected server error.
...
/*!
  ...
  \param purchase_handle This is a handle that was created by MLPurchaseCreate.
  \retval MLCloudResult_InvalidHandle indicates the provided query handle is not valid.
  \retval MLResult_UnspecifiedFailure indicates an unexpected failure.
  \retval MLResult_Ok is returned on success.
  \priv none
...
/*!
  ...
  \param history_handle This is a handle that was created by MLPurchaseHistoryQueryCreate.
  \param limit This is the maximum number of items that will be returned in a single page.
  \retval MLCloudResult_InvalidHandle indicates the provided query handle is not valid.
  \retval MLCloudResult_SystemError indicates an issue with the cloud service, e.g. if the service is not available for any reason.
  \retval MLResult_PrivilegeDenied indicates an privilege error with the purchase details system call.
  \retval MLResult_UnspecifiedFailure indicates an unexpected failure.
...
/*!
  ...
  \param history_handle This is a handle that was used to call
  MLPurchaseHistoryQueryPage.
  ...
  \retval MLCloudResult_InvalidHandle indicates the provided query handle is not valid.
  \retval MLCloudResult_SystemError indicates an issue with the cloud service, e.g. if the service is not available for any reason.
  \retval MLResult_AllocFailed is returned if the memory for the response cannot be allocated.
  \retval MLResult_InvalidParam is returned if any input parameters are invalid.
  \retval MLResult_UnspecifiedFailure indicates an unexpected failure.
  \retval MLResult_Ok is returned on success.
  \priv none
