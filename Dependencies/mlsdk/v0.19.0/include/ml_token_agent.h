...
/*!
  \brief The #TokenAgent functions return a MLResult value. If the result does not match
   one of the MLResultGlobal values, it can be safely cast to an #MLTokenAgentResult.
*/
...
/*!
  ...
  \retval MLResult_Ok The operation completed successfully before the timeout elapsed.
          ...
          If any other value is returned, the location pointed to by out_credentials is set to
          0 (null)
