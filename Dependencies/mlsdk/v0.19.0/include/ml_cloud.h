...
/*! This represents a generic cloud result. */
typedef enum MLCloudResult {
  ...
  /*!
    \brief The request may not have made it to the server. The service did not
  ...
  /*!
    \brief The handle that was passed in is not a valid handle for the API call
    it was used in.
   */
