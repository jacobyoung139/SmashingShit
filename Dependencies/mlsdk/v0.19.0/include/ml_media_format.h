...
/*!
  \brief Destroy a \ref MediaFormat object.
  \param[in] handle #MLHandle to the \ref MediaFormat object.
  \retval MLResult_Ok if \ref MediaCodec object was successfully destroyed.
