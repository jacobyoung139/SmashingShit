...
/*!
  \brief Create a \ref MediaCrypto instance from a UUID.
  ...
  \param[out] out_handle Upon successful return will point to handle to the created \ref MediaCrypto.
              Or else, it will point to #ML_INVALID_HANDLE.
  \retval MLResult_Ok \ref MediaCrypto object was created successfully.
...
/*!
  \brief Release the \ref MediaCrypto instance.
  \param[in] media_crypto #MLHandle to the \ref MediaCrypto.
  \retval MLResult_Ok \ref MediaCrypto object was successfully destroyed.
  \retval MLResult_InvalidParam \ref MediaCrypto object is invalid.
  \retval MLResult_UnspecifiedFailure The operation failed with an unspecified error.
  \priv none
*/
...
/*!
  \brief Associate a #MediaDRM session with this \ref MediaCrypto instance.
  \param[in] media_crypto #MLHandle to the \ref MediaCrypto.
