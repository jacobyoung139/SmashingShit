...
/*!
  \brief Type used to represent a 3D polygon on a 2D plane.
  \apilevel 2
*/
typedef struct MLPolygon {
  /*! Vertices of all polygons in a plane. */
  MLVec3f *vertices;
  /*! Count of vertices. */
...
/*!
  ...
  \retval MLResult_UnspecifiedFailure The operation failed with an unspecified error.
  \priv WorldReconstruction
  \deprecated Deprecated since 0.19.0. Scheduled for removal. Replaced by \ref MLPlanesQueryGetResultsWithBoundaries
*/
ML_API MLResult ML_CALL MLPlanesQueryGetResults(MLHandle planes_tracker, MLHandle planes_query, MLPlane *out_results, uint32_t *out_num_results);
...
/*!
  ...
  \param[out] out_boundaries A pointer to #MLPlaneBoundariesList for the returned polygons.
              If out_boundaries is NULL, the function call is the same as #MPlanesQueryGetResults,
