...
/*!
  \brief Create a new \ref MediaExtractor.
  \param[out] out_handle A handle to the created \ref MediaExtractor.
...
/*!
  \brief Destroy a \ref MediaExtractor.
  \param[in] handle #MLHandle to the \ref MediaExtractor object.
  \retval MLResult_Ok if operation succeeded.
...
/*!
  ...
  \param[in] handle #MLHandle to the \ref MediaExtractor.
...
/*!
  ...
  \param[out] out_track_handle \ref MediaFormat handle that represents
              track format.
  \retval MLResult_Ok if operation succeeded.
  \retval MLResult_InvalidParam if one of parameters is invalid.
  \retval MLResult_UnspecifiedFailure The operation failed with an unspecified error.
...
/*!
  ...
  \param[in] handle #MLHandle to the \ref MediaExtractor instance.
  \retval MLResult_Ok if operation succeeded.
  \retval MLResult_InvalidParam if handle is invalid.
