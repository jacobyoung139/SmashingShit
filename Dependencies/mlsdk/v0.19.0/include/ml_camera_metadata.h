...
/*!
  ...
  \brief APIs for getting/setting camera characteristic/request/result
         metadata.
...
/*!
  ...
  \param[out] out_data List of stream configuration settings.
              Each setting is consisted of [#MLCameraMetadataScalerAvailableFormats, width, height, #MLCameraMetadataScalerAvailableStreamConfigurations].
              The Library allocates and maintains the lifetime of the output data.
