...
/*!
  ...
  \deprecated Deprecated since 0.15.0. Scheduled for removal.
    Replaced by \ref Meshing2
...
typedef struct MLMeshingSettings {
  ...
  */
  ...
  /*!
    ...
    Use 0 to request an unsimplified mesh.
...
/*!
  ...
  \deprecated Deprecated since 0.15.0. Scheduled for removal. Replaced by \ref Meshing2
  \param[in] settings The configuration for the meshing system.
  \param[out] out_handle A pointer to an #MLHandle which will contain the handle to the meshing tracker.
              If this operation fails, out_handle will be #ML_INVALID_HANDLE.

  \retval MLResult_Ok The meshing tracker was created successfully.
...
*/
ML_API MLResult ML_CALL MLMeshingCreate(const MLMeshingSettings *settings, MLHandle *out_handle);
...
/*!
  ...
  \retval MLResult_Ok The meshing tracker was successfully destroyed.
  \retval MLResult_UnspecifiedFailure The operation failed with an unspecified error.
  \priv WorldReconstruction
*/
ML_API MLResult ML_CALL MLMeshingDestroy(MLHandle mesh_tracker);
...
/*!
  ...
  \retval MLResult_Ok The meshing settings were successfully applied.
  \retval MLResult_InvalidParam The parameter settings was not valid (null).
  \retval MLResult_UnspecifiedFailure The operation failed with an unspecified error.
  \priv WorldReconstruction
*/
ML_API MLResult ML_CALL MLMeshingUpdate(MLHandle mesh_tracker, const MLMeshingSettings *settings);
...
/*!
  ...
  \retval MLResult_Ok The mesh successfully refreshed.
  \retval MLResult_UnspecifiedFailure The operation failed with an unspecified error.
  \priv WorldReconstruction
*/
ML_API MLResult ML_CALL MLMeshingRefresh(MLHandle mesh_tracker);
...
/*!
  ...
  \retval MLResult_Ok The static data was successfully populated.
  \retval MLResult_InvalidParam The parameter out_data was not valid (null).
  \retval MLResult_UnspecifiedFailure The operation failed with an unspecified error.
  \priv WorldReconstruction
*/
ML_API MLResult ML_CALL MLMeshingGetStaticData(MLHandle mesh_tracker, MLMeshingStaticData *out_data);
