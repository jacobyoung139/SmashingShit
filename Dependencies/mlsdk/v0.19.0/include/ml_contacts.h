...
/*!
  \struct MLContactsTaggedAttribute
...
/*!
  \brief Initializes default values for \see MLContactsTaggedAttribute.
  \param[in, out] in_out_attr.
  \apilevel 2
*/
...
/*!
  \struct MLContactsTaggedAttributeList
...
/*!
  \brief Initializes default values for \see MLContactsTaggedAttributeList.
  \param[in, out] in_out_attr_list.
  \apilevel 2
*/
...
/*!
  \struct MLContactPhoneNumbersList
...
/*!
  \brief Initializes default values for \see MLContactsContact.
  \param[in, out] in_out_contact.
  \apilevel 2
*/
...
/*!
  \brief Initializes default values for \see MLContactsContactList.
  \param[in, out] in_out_contact_list.
  \apilevel 2
*/
...
/*!
  \enum MLContactsResult
  \brief Return values for API calls that are relevant to contacts.
  \apilevel 2
*/
typedef enum MLContactsResult {
  ...
  /*!
    Request is completed, its corresponding result has been returned, and its related resources
  ...
  */
  ...
  /*!
    Request failed due to system being in an illegal state, for e.g., when the user hasn't
...
/*!
  \brief MLContacts default constants.
  \apilevel 2
*/
enum {
  /*! Default fetch limit for retrieval based operations. */
  MLContacts_DefaultFetchLimit = 250
};

/*!
  \typedef MLContactsOffset
  \apilevel 2
*/
typedef const char *MLContactsOffset;

/*!
  \struct MLContactsListArgs
  \brief Stores arguments for a List request (\see MLContactsRequestList).
  \apilevel 2
*/
...
/*!
  \brief Initializes default values for \see MLContactsListArgs.
  \param[in, out] in_out_args.
  \apilevel 2
*/
...
/*!
  \brief Initializes default values for \see MLContactsSearchArgs.
  \param[in, out] in_out_args.
  \apilevel 2
*/
...
/*!
  \enum MLContactsOperationStatus
...
/*!
  \struct MLContactsOperationResult
...
typedef struct MLContactsOperationResult {
  ...
  /*!
    ...
    in this resultant contact for \see MLContactsRequestContactInsert.
  */
  const MLContactsContact *contact;
} MLContactsOperationResult;

/*!
  \brief Initializes default values for \see MLContactsOperationResult.
  \param[in, out] in_out_result
  \apilevel 2
*/
...
/*!
  \brief Initializes default values for \see MLContactsListResult.
  \param[in, out] in_out_result
  \apilevel 2
*/
...
/*!
  ...
  \return result of submission of request.
...
/*!
  ...
  \param[out] out_result \see MLContactsOperationResult.

  \return result of this attempt to retrieve outcome of that operation corresponding to the handle.
...
/*!
  \brief Try to get result of a request which is expected to return
  \see MLContactsListResult (i.e .List or Search).

  \param[in] handle.
  \param[out] out_result \see MLContactsListResult.
...
/*!
  ...
  \return result of cancelling the request.
...
/*!
  ...
  \return result of freeing resources for the request.
