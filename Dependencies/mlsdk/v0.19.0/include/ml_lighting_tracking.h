...
/*!
  ...
  \priv LowLatencyLightwear
*/
ML_API MLResult ML_CALL MLLightingTrackingDestroy(const MLHandle lighting_tracker);
...
/*!
  ...
  \priv LowLatencyLightwear
*/
ML_API MLResult ML_CALL MLLightingTrackingGetAmbientGlobalState(const MLHandle lighting_tracker, MLLightingTrackingAmbientGlobalState *out_state);
...
/*!
  ...
  \priv LowLatencyLightwear
*/
ML_API MLResult ML_CALL MLLightingTrackingGetAmbientGridState(const MLHandle lighting_tracker, MLLightingTrackingAmbientGridState *out_state);
...
/*!
  ...
  \priv LowLatencyLightwear
*/
ML_API MLResult ML_CALL MLLightingTrackingGetColorTemperatureState(const MLHandle lighting_tracker, MLLightingTrackingColorTemperatureState *out_state);
