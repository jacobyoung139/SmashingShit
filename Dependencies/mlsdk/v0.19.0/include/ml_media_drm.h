...
/*!
  \brief \ref MediaDRM event listener callback function - user of ml_media_drm.h should implement this.
...
/*!
  \brief Create a \ref MediaDRM instance from a UUID.
  \param[in] uuid The universal unique ID of the crypto scheme. uuid must be 16 bytes.
  \param[out] out_handle Upon successful return will point to handle to the created \ref MediaDRM.
              Or else, it will point to #ML_INVALID_HANDLE.
  \retval MLResult_Ok \ref MediaDRM object was created successfully.
  \retval MLResult_InvalidParam One of the parameters is invalid.
  \retval MLResult_AllocFailed \ref MediaDRM object creation failed with resource allocation failure.
  \retval MLResult_UnspecifiedFailure The operation failed with an unspecified error.
  \priv none
*/
...
/*!
  \brief Release the \ref MediaDRM instance.
  \param[in] media_drm #MLHandle to the \ref MediaDRM.
  \retval MLResult_Ok \ref MediaDRM object was released successfully.
  \retval MLResult_InvalidParam One of the parameters is invalid.
  \retval MLResult_UnspecifiedFailure The operation failed with an unspecified error.
  \priv none
*/
...
/*!
  ...
  \retval MLResult_Ok \ref MediaDRM session was opened successfully.
  \retval MLResult_InvalidParam Parameter is invalid.
  \retval MLResult_UnspecifiedFailure The operation failed with an unspecified error.
  \priv none
*/
...
/*!
  \brief Closes a session on the \ref MediaDRM object that was previously opened with openSession().
  \param[in] media_drm #MLHandle to the \ref MediaDRM.
  \param[in] session_id The session ID for the DRM session, which will be released on return.
  \retval MLResult_Ok \ref MediaDRM session was closed successfully.
  \retval MLResult_InvalidParam Parameter is invalid.
  \retval MLResult_UnspecifiedFailure The operation failed with an unspecified error.
  \priv none
*/
...
/*!
  ...
  \retval MLResult_Ok \ref MediaDRM Key Request message is constructed successfully.
  \retval MLResult_InvalidParam Parameter is invalid.
  \retval MLResult_UnspecifiedFailure The operation failed with an unspecified error.
  \priv none
*/
...
/*!
  ...
  \retval MLResult_Ok \ref MediaDRM Key Response message was consumed successfully.
  \retval MLResult_InvalidParam Parameter is invalid.
  \retval MLResult_UnspecifiedFailure The operation failed with an unspecified error.
  \priv none
*/
...
/*!
  ...
  \retval MLResult_Ok \ref MediaDRM Keys are restored successfully.
  \retval MLResult_InvalidParam Parameter is invalid.
  \retval MLResult_UnspecifiedFailure The operation failed with an unspecified error.
  \priv none
*/
...
/*!
  ...
  \retval MLResult_Ok \ref MediaDRM Keys are removed successfully.
  \retval MLResult_InvalidParam Parameter is invalid.
  \retval MLResult_UnspecifiedFailure The operation failed with an unspecified error.
  \priv none
*/
...
/*!
  ...
  \retval MLResult_Ok Query for \ref MediaDRM Key status completed successfully.
  \retval MLResult_InvalidParam Parameter is invalid.
  \retval MLResult_UnspecifiedFailure The operation failed with an unspecified error.
  \priv none
*/
...
/*!
  ...
  \retval MLResult_Ok \ref MediaDRM Secure stops are retrieved successfully.
  \retval MLResult_InvalidParam Parameter is invalid.
  \retval MLResult_UnspecifiedFailure The operation failed with an unspecified error.
  \priv none
*/
...
/*!
  ...
  \param[out] out_secure_stop The secure stop upon successful return.
              To free/release call MLMediaDRMByteArrayRelease().
  \retval MLResult_Ok \ref MediaDRM Secure stop is retrieved successfully.
  \retval MLResult_InvalidParam Parameter is invalid.
  \retval MLResult_UnspecifiedFailure The operation failed with an unspecified error.
  \priv none
*/
...
/*!
  ...
  \retval MLResult_Ok \ref MediaDRM Secure stops are released successfully.
  \retval MLResult_InvalidParam Parameter is invalid.
  \retval MLResult_UnspecifiedFailure The operation failed with an unspecified error.
  \priv none
*/
...
/*!
  ...
  \param[in] media_drm #MLHandle to the \ref MediaDRM.
  \retval MLResult_Ok All secure stops for the \ref MediaDRM are released successfully.
  \retval MLResult_InvalidParam Parameter is invalid.
  \retval MLResult_UnspecifiedFailure The operation failed with an unspecified error.
  \priv none
*/
...
/*!
  ...
  \retval MLResult_Ok \ref MediaDRM property is retrieved successfully.
  \retval MLResult_InvalidParam Parameter is invalid.
  \retval MLResult_UnspecifiedFailure The operation failed with an unspecified error.
  \priv none
*/
...
/*!
  ...
  \retval MLResult_Ok \ref MediaDRM property is set successfully.
  \retval MLResult_InvalidParam Parameter is invalid.
  \retval MLResult_UnspecifiedFailure The operation failed with an unspecified error.
  \priv none
*/
...
/*!
  ...
  \param[out] out_output The encrypted input upon successful return.
              To free/release this buffer, call MLMediaDRMByteArrayRelease().
  \retval MLResult_Ok \ref MediaDRM encryption operation has been completed successfully.
  \retval MLResult_InvalidParam Parameter is invalid.
  \retval MLResult_UnspecifiedFailure The operation failed with an unspecified error.
  \priv none
*/
...
/*!
  ...
  \param[out] out_output The decrypted input upon successful return.
              To free/release this buffer, call MLMediaDRMByteArrayRelease().
  \retval MLResult_Ok \ref MediaDRM decryption operation has been completed successfully.
  \retval MLResult_InvalidParam Parameter is invalid.
  \retval MLResult_UnspecifiedFailure The operation failed with an unspecified error.
  \priv none
*/
...
/*!
  ...
  \param[out] out_signature The signature of the input message upon success.
              To free/release this buffer, call MLMediaDRMByteArrayRelease().
  \retval MLResult_Ok \ref MediaDRM HMAC Sign operation has been completed successfully.
  \retval MLResult_InvalidParam Parameter is invalid.
  \retval MLResult_UnspecifiedFailure The operation failed with an unspecified error.
  \priv none
*/
...
/*!
  ...
  \param[out] out_match pointer to bool, which would return "true" if the signature matches,
              "false" otherwise.
  \retval MLResult_Ok \ref MediaDRM HMAC Verify operation has been completed successfully.
  \retval MLResult_InvalidParam Parameter is invalid.
  \retval MLResult_UnspecifiedFailure The operation failed with an unspecified error.
  \priv none
*/
...
/*!
  ...
  \retval MLResult_Ok \ref MediaDRM RSA Sign operation has been completed successfully.
  \retval MLResult_InvalidParam Parameter is invalid.
